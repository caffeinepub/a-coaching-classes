...
const faculty = [
  ...
  },
  {
    ...
    experience: "25+ Years",
    bio: "A highly experienced biology educator with a Ph.D. and over two decades of teaching excellence. Her student-centric approach and detailed NCERT coverage set students up for board and competitive exam success.",
    color: "bg-rose-600",
